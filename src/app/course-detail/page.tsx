    ...
    <>
      ...
      <body>
        ...
        <section className="row">
          <main>
            <div
              className={`course-details ${styles.cartao} align-items-center`}
            >
              <div className={`${styles.cont} container`}>
                <nav className={styles.nav}>
                  <ul className={styles['conteudoPrincipal-cursos-link']}>
                    <li>
              ...
              <h2 className="text-light text-center">{course.name}</h2>
              <p className="text-light text-center">{course.description}</p>
              <p className="text-light text-center">Duração: 10 semanas</p>
              <p className="text-light text-center">
                Preço: R${course.price.toString().replace('.', ',')}
              </p>
        ...
        <footer className="text-center text-lg-start bg-light text-muted mt-lg-5">
