  ...
  return (
    <>
      <Head>
        ...
        <title>tart Cursos</title>
      </Head>
      <body>
        <Header />

        <section
          className={`${styles['justify-content-start']} row justify-content-start ms-5`}
        >
          <div className="col-4 pe-lg-5 ">
            <div className="list-group">
              <h2 className="mb-2 text-light">Produto</h2>

              {cart.map(
                (course: { id: number; name: string; price: number }) => {
                  return (
                    <label className="list-group-item" key={course.id}>
          ...
          <div className="col-6">
            <section className={styles.opcoesPagamento}>
              <h2 className="mb-2 text-light">Formas de Pagamento</h2>
              <div
                className="accordion accordion-flush"
                id="accordionFlushExample"
              />
              <div className={`${styles['bg-item']} accordion-item`}>
                ...
                <div
                  ...
                  className={`${styles['item-interno']} accordion-collapse collapse`}
                ...
                >
                  ...
                  <div className="text-center">
                    <Image src={qrcode} className="img-fluid" alt="..." />
                  </div>
                </div>
              </div>
              <div className={`${styles['bg-item']} accordion-item`}>
                ...
                <div
                  ...
                  data-bs-parent="#accordionFlushExample"
                >
                  <div className={`${styles['item-interno']} accordion-body`}>
                    <form action="">
              ...
              <div className={`${styles['bg-item']} accordion-item`}>
                ...
                <div
                  ...
                  className={`${styles['item-interno']}accordion-collapse collapse p-2`}
                  aria-labelledby="flush-headingThree"
                  data-bs-parent="#accordionFlushExample"
                >
                  <div className="input-group-sm d-flex w-50 m-3 mb-3">
                    <button
                    ...
                    <input
                      ...
                      placeholder="15.288.983/0001-80"
                      aria-label="15.288.983/0001-80"
        ...
        <footer className="text-center text-lg-start bg-light text-muted mt-xxl-5">
              ...
              <div className="row mt-3">
                <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                  ...
                  <p>
                    ...
                    conveniência do mundo digital. Na Start Cursos, acreditamos
                    que o aprendizado é uma jornada contínua, e estamos
                    comprometidos em fornecer a você as ferramentas necessárias
                    para começar e avançar nesse caminho.
                  </p>
                </div>
