...
import courseImg from '../../assets/images/background1.svg'
    ...
    <>
      ...
      <body>
        ...
        <footer className="text-center text-lg-start bg-light text-muted mt-xxl-5">
            ...
            <div className="container text-center text-md-start mt-5">
              <div className="row mt-3">
                ...
                <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                  ...
                  <p>
                    <i className="fas fa-home me-3"></i> Xanxerê, 2023, SC
                  </p>
                  <p>
          ...
          >
            © 2023 Copyright:
            <a className="text-reset fw-bold">StartCursos</a>
          </div>
        </footer>
      </body>
    </>
